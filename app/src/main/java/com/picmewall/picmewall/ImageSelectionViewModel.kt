...
class ImageSelectionViewModel(application: Application) : AndroidViewModel(application) {
    val selectedImages: HashMap<Long, ImageSelection> = HashMap()
    ...
    private suspend fun queryImages(): List<MediaStoreImage> {
        ...
        withContext(Dispatchers.IO) {
            ...
            val selectionArgs = arrayOf(
                ...
                dateToTimestamp(day = 22, month = 10, year = 1990).toString()
            )
            ...
            getApplication<Application>().contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    val image = MediaStoreImage(id, displayName, dateModified, contentUri, height, width)
                    images += image
